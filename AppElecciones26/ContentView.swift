...
//  Elecciones2026
//
//  Created by user278624 on 10/14/25.
//
...
struct ContentView: View {
    ...
    let partidos: [PartidoItem] = [
        ...
        PartidoItem(name:"Renovacion Popular",candidato: "Rafeal Lopez Aliaga", imagePartido: "partido2", imageCandidato: "candidato2"),
